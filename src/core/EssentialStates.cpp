...
static std::unordered_map<
    util::Sign, std::array<std::tuple<swephpp::PlanetaryBody, double>, 5>>
    terms{
        {
            util::Sign::Aries,
            {
...
bool IsInOwnTerm(const Planet &p) {
  ...
  std::array<std::tuple<swephpp::PlanetaryBody, double>, 5> &a =
      terms[static_cast<util::Sign>(sign)];
